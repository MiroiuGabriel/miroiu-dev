...
<Callout icon="💡">
	...
	[the official documentation](https://duckduckgo.com "The best search engine
	for privacy")
</Callout>
...
Now whenever the state changes, it will only re-render the `ButtonWithPopover` component.
...
We can apply the previous optimization with a twist.
